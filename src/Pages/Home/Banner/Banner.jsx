                    ...
                    <Row className="align-items-center">
                        <Col md={12} sm={12} lg={6}>
                            <div className="hero-slide-left justify-content-end align-items-center text-center text-lg-start">
                                <h2>Your best life begins with a smile.</h2>
                                <h1>A great smile can start a great day!</h1>
                                <p className="mb-xs-5">For friendly doctor, Join us. We are here to help you.</p>
