                                ...
                                <div className="row g-0">
                                    <div className="col-lg-6">
                                        <div className="card-body p-md-5 mx-md-4">
                                            <div className="text-center">
                                                <img src="https://th.bing.com/th/id/OIP.dn12_MLxJQcvcYE5Rz3LtwHaEK?pid=ImgDet&rs=1" className="card-img" alt="logo" />
                                                <h4 className="mt-1 mb-5 pb-1">We are The Crocodile Team</h4>
                                            </div>
                                            <p className="d-flex justify-content-start">Sign in to your account</p>
                                            <form onSubmit={handleSubmit}>
                                                ...
                                                <div className="d-flex align-items-center justify-content-center pb-4">
                                                    ...
                                                    <button type="button" className="btn btn-outline-danger">Create new account</button>
                                                </div>
                                    ...
                                    <div className="col-lg-6 d-flex align-items-center gradient-custom-2">
                                        <div className="text-white px-3 py-4 p-md-5 mx-md-4">
                                            <h4 className="mb-4">Dental Care is our game. Excellence is our goal.</h4>
